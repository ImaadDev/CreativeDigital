  ...
  return (
    <section className="py-20 max-w-7xl mx-auto bg-black relative z-30 px-8 md:px-12">
      ...
      <ScrollBasedAnimation direction="up" offset={50}>
        <p className="text-gray-300 text-lg leading-relaxed mb-10 first-letter:text-4xl first-letter:font-bold first-letter:text-accent first-letter:mr-2 first-letter:float-left">
          {blog.introduction}
        </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-8">
            {prevBlog ? (
              <Link href={`/blogs/${prevBlog.slug}`} className="group flex-1">
                <div className="bg-gray-900 hover:bg-gray-800 p-6 rounded-lg transition-all duration-300 transform hover:scale-105 border border-gray-700 hover:border-accent">
      ...
      <ScrollBasedAnimation direction="up" offset={50} delay={0.4}>
        <div className="text-center mt-16">
          <Link
            href="/blogs"
            className="inline-flex items-center bg-accent hover:bg-green-500 text-black font-semibold py-4 px-8 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >

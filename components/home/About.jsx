...
const AboutUs = () => {
  return (
    <section className="flex flex-col lg:flex-row items-stretch py-12 lg:py-0 max-w-[1400px] mx-auto bg-primary relative z-30">
      ...
      <div className="lg:w-1/2 w-full px-8 md:px-12 lg:px-16 xl:px-20 flex flex-col justify-center">
        <ScrollBasedAnimation direction="right" offset={50} delay={0}>
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-black mb-10 tracking-tight leading-[1.1]">
            OUR STORY
          </h2>
        ...
        <ScrollBasedAnimation direction="left" offset={50} delay={0.1}>
          <p className="text-lg md:text-xl text-gray-800 leading-relaxed mb-6 font-light">
            Founded in Riyadh, <span className="font-medium text-black">CreativeDigital</span> bridges the gap between traditional business and the digital future. We help brands grow by combining local expertise with innovative digital strategies.
          </p>
        </ScrollBasedAnimation>

        <ScrollBasedAnimation direction="left" offset={50} delay={0.2}>
          <p className="text-lg md:text-xl text-gray-800 leading-relaxed mb-6 font-light">
            Our team has helped over <span className="font-medium text-black">200+ businesses</span> transform their digital presence with solutions that are creative, authentic, and results-driven.
          </p>
        </ScrollBasedAnimation>
